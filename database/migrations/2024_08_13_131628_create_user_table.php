...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::create($this->table_name, function (Blueprint $table) {
            ...
            $table->tinyInteger('spread_open',1)->default(1)->comment('是否有推广资格');
            ...
            $table->tinyInteger('is_money_level',1)->default(0)->comment('会员来源  0: 购买商品升级   1：花钱购买的会员2: 会员卡领取');
            $table->tinyInteger('is_ever_level',1)->default(0)->comment('是否永久性会员  0: 非永久会员  1：永久会员');
            ...
            $table->tinyInteger('division_type',1)->default(0)->comment('代理类型：0普通，1事业部，2代理，3员工');
            $table->tinyInteger('division_status',1)->default(0)->comment('代理状态');
            $table->tinyInteger('is_division',1)->default(0)->comment('事业部状态');
            $table->tinyInteger('is_agent',1)->default(0)->comment('代理状态');
            $table->tinyInteger('is_staff',1)->default(0)->comment('员工状态');
