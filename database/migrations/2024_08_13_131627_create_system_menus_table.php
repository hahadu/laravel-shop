...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::create($this->table_name, function (Blueprint $table) {
            ...
            $table->smallint('pid')->index()->unsigned()->default(0)->comment('父级id');
            ...
            $table->tinyInteger('is_show_path',1)->default(0)->comment('是否为隐藏菜单供前台使用');
            ...
            $table->tinyInteger('auth_type',1)->default(0)->comment('是否为菜单 1菜单 2功能');
            $table->char('header',50)->default('')->comment('顶部菜单标示');
            $table->tinyInteger('is_header',1)->default(0)->comment('是否顶部菜单1是0否');
