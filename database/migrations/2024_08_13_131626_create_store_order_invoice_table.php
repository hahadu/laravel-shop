...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::create($this->table_name, function (Blueprint $table) {
            ...
            $table->tinyInteger('header_type',1)->default(1)->comment('抬头类型');
            $table->tinyInteger('type',1)->default(1)->comment('发票类型');
            ...
            $table->tinyInteger('is_pay',1)->default(0)->comment('是否支付');
            $table->tinyInteger('is_refund',1)->default(0)->comment('订单是否退款');
            $table->tinyInteger('is_invoice',1)->default(0)->comment('是否开票');
            ...
            $table->tinyInteger('is_del',1)->nullable()->default(0)->comment('是否删除');
        });
