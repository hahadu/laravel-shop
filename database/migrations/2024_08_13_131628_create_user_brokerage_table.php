...
return new class extends Migration {
    ...
    private string $table_name = 'user_brokerage';
    ...
    public function up(): void
    {
        Schema::create($this->table_name, function (Blueprint $table) {
            ...
            $table->integer('frozen_time')->unsigned()->default(0)->comment('冻结到期时间');
            $table->integer('add_time')->index()->unsigned()->default(0)->comment('添加时间');
        });
        $this->setTableComment($this->table_name, '用户分佣账单表');
    }
