...
return new class extends Migration {
    ...
    private string $table_name = 'user_bill';
    ...
    public function up(): void
    {
        Schema::create($this->table_name, function (Blueprint $table) {
            ...
            $table->char('category',64)->default('')->comment('明细种类');
            ...
            $table->tinyInteger('status',1)->index()->default(1)->comment('0 = 带确定 1 = 有效 -1 = 无效');
            $table->tinyInteger('take',1)->default(0)->comment('0 = 未收货 1 = 已收货');
            $table->integer('frozen_time')->default(0)->comment('积分冻结时间');
        });
        $this->setTableComment($this->table_name, '用户账单表');
    }
