...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::create($this->table_name, function (Blueprint $table) {
            ...
            $table->tinyInteger('is_tourist',1)->default(0)->comment('是否是游客');
            $table->tinyInteger('online',1)->default(0)->comment('是否在线');
            $table->tinyInteger('type',1)->default(0)->comment('0 = pc,1=微信，2=小程序，3=H5');
            ...
            $table->tinyInteger('message_type',1)->default(0)->comment('消息类型');
        });
