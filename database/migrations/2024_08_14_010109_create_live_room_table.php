...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::create($this->table_name, function (Blueprint $table) {
            ...
            $table->tinyInteger('status')->default(0)->comment('审核状态0=未审核1=微信审核2=审核通过-1=审核未通过');
            $table->smallInteger('live_status')->unsigned()->default(102)->comment('直播状态101：直播中，102：未开始，103已结束，104禁播，105：暂停，106：异常，107：已过期');
