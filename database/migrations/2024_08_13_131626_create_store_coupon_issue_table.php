...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::create($this->table_name, function (Blueprint $table) {
            ...
            $table->tinyInteger('is_permanent',1)->default(0)->comment('是否无限张数');
            $table->tinyInteger('status',1)->index()->default(1)->comment('1 正常 0 未开启 -1 已无效');
            $table->tinyInteger('is_give_subscribe',1)->default(0)->comment('是否首次关注赠送 0-否(默认) 1-是');
            $table->tinyInteger('is_full_give',1)->default(0)->comment('是否满赠0-否(默认) 1-是');
            ...
            $table->tinyInteger('receive_type',1)->default(0)->comment('1 手动领取，2 新人券，3赠送券，4会员券');
