...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::create($this->table_name, function (Blueprint $table) {
            ...
            $table->tinyInteger('type')->default(1)->comment('1=本地存储,2=七牛,3=oss,4=cos');
            ...
            $table->tinyInteger('is_ssl')->default(0)->comment('0=http,1=https');
            $table->tinyInteger('status')->index()->default(0)->comment('状态');
            $table->tinyInteger('is_delete')->index()->default(0)->comment('是否删除');
