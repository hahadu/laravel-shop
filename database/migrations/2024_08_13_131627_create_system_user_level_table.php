...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::create($this->table_name, function (Blueprint $table) {
            ...
            $table->tinyInteger('is_forever',1)->default(0)->comment('是否为永久会员');
            $table->tinyInteger('is_pay',1)->default(0)->comment('是否购买,1=购买,0=不购买');
            $table->tinyInteger('is_show',1)->default(0)->comment('是否显示 1=显示,0=隐藏');
            ...
            $table->tinyInteger('is_del',1)->default(0)->comment('是否删除.1=删除,0=未删除');
